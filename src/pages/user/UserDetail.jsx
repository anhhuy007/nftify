      ...
      <div className="w-full rounded-xl overflow-hidden">
        ...
        <div className="-mt-20">
          ...
          <div className="flex gap-80 mt-6 space-y-4">
            ...
            <Card className="flex-1 p-4 space-y-2 bg-card text-primary-foreground border-none max-h-fit">
              <div className="flex gap-28">
                <span className="text-gray-400">Followers</span>
                <span className="whitespace-nowrap">{user.followers} ETH</span>
              </div>
              <div className="flex  gap-28">
                <span className="text-gray-400">Following</span>
                <span className="whitespace-nowrap">{user.following} ETH</span>
              </div>
